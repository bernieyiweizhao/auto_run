...
# Notes:
# - RDS is not created when only filter step was active
# - add lines for rho and delta in densityPeak plot (page 15)
# - Cluster category: don't show rho and delta parameters when cluster number is selected. also set them to null in the clusterCells function
# - subsetting: based on dispersion
# - fix pheatmap (cell rager)
# - show tSNE plot colored by rho and delta?
# - fix the one cluster vs. others method
# - add cluster isDE column to genes.txt (multiple when one cluster vs. others)
